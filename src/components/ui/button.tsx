  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-primary text-primary-foreground hover:shadow-glow hover:scale-105 active:scale-95 font-bold text-lg",
        accent: "bg-gradient-accent text-accent-foreground hover:shadow-accent-glow hover:scale-105 active:scale-95",
        winner: "bg-gradient-winner text-success-foreground hover:shadow-winner-glow hover:scale-105 animate-pulse-glow",
        battle: "bg-gradient-battle text-primary-foreground hover:shadow-glow hover:scale-105 active:scale-95 font-bold",
      },
      size: {
